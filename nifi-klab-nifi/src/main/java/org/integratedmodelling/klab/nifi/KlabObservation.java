        ...
        public void onTrigger(ProcessContext context, ProcessSession session) throws ProcessException { 
            ...
            if (jsonObject == null) {
                ...
                return;
                            ...
                            String obsSematics = jsonObject.has("semantics") ? jsonObject.get("semantics").getAsString() : null; 
                            ...
                            } // If Geometry is null it's still fine 
                            ...
                            Observable observable = contextScope.getService(Reasoner.class).resolveObservable(obsSematics); 

                            getLogger().info((LogMessage) observable); 
                            ...
                            try { 
                                ...
                                session.remove(flowfile); session.transfer(successFlowFile, REL_SUCCESS); 
                            } catch (Exception e) { 
                            ...
                            getLogger().warn("Received empty or invalid JSON"); 
                            session.transfer(flowfile, REL_FAILURE); // If bad json, then transfer to FAILURE relation 
                        } 
                    } catch (Exception e) { 
